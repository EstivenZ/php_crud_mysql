        ...
        <div class="col-md-5">
            ...
            <div class="card card-body">
                <form action="save_task.php" method="POST">
                    ...
                    <div class="form-group">
                        <textarea name="description" rows="2" class="form-control mt-2" placeholder="Descripción de la tarea"></textarea>
                    </div>
                ...
                <tbody>
                    ...
                    while($row = mysqli_fetch_array($result_task)) { ?>
                        <tr>
                            ...
                            <td>
                                <a href="edit_task.php?id=<?php echo $row['id'] ?>" class="btn btn-warning"><i class="fas fa-edit"></i></a>
